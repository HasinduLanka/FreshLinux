...
sudo apt -y install wmctrl xdotool libinput-tools  gir1.2-gtop-2.0 gir1.2-nm-1.0 gir1.2-clutter-1.0 pulseaudio scrot kde-spectacle kdialog qml-module-qt-labs-platform 
